...
## Polymer Starter Kit, Electron Edition

> A starting point for building web applications with Polymer 1.0. This particular fork shows how to use Polymer Starter
> Kit under Electron, via [electron-compile](https://github.com/paulcbetts/electron-compile)

### Run The App:

```sh
npm install && bower install && ./node_modules/.bin/electron ./app.js
```
